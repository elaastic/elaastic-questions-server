  ...
  <v-card class="border-sm rounded-0 " :max-height="125" :elevation="0" :style="'background-color: ' + color">
    <v-card-title class="font-weight-bold">
      ...
      <span v-show="!isSelected">
        <svg class="position-absolute right-0 mt-3" v-if="props.sequenceState === 'RESPONSE_PHASE'" xmlns="http://www.w3.org/2000/svg" width="100" height="50" viewBox="0 0 110 67" fill="none" :stroke="'lightgray'" stroke-width="4">
        ...
        <svg class="position-absolute right-0 mt-3" v-if="props.sequenceState === 'CONFRONTING_VIEWPOINT'" xmlns="http://www.w3.org/2000/svg" width="120" height="60" viewBox="0 0 160 90" fill="none" :stroke="'lightgray'" stroke-width="4">
        ...
        <svg class="position-absolute right-0 mt-3" v-if="props.sequenceState === 'RESULTS_PHASE'" xmlns="http://www.w3.org/2000/svg" width="80" height="60" viewBox="0 0 100 80" fill="none" :stroke="'lightgray'" stroke-width="4">
        ...
        <svg class="position-absolute right-0" v-if="props.sequenceState === 'CLOSED'" width="100" height="100" viewBox="0 0 100 150" xmlns="http://www.w3.org/2000/svg">
          <rect x="20" y="60" width="70" height="40" rx="10" ry="10" fill="lightgray" stroke="lightgray" stroke-width="2"/>
          <path d="M30 60 V40 A20 20 0 0 1 77 40 V60" fill="none" stroke="lightgray" stroke-width="5"/>
        </svg>

        <svg class="position-absolute right-0 mt-7" v-if="props.sequenceState === 'NOT_STARTED'" width="100" height="20" viewBox="0 0 100 20" xmlns="http://www.w3.org/2000/svg">
