...
const props = defineProps({
  /**
   * The definitive answers of the results chart. It's an array of 3-uplet : the number of the answer, the percentage of students who have chosen this answer and a boolean to say if it's the good answer.
   */
  dataDefinitiveVote: {
  ...
  /**
   * The temporary answers of the results chart. It's an array of 3-uplet : the number of the answer, the percentage of students who have chosen this answer and a boolean to say if it's the good answer.
   */
  dataTemporaryVote: {
    type: Array<{ itemIndex: number, value: number, isCorrect: boolean }>,
    default: () => []
...
<template>
  <ContentBlock :title="t('results')" :readonly="true" :open="true" subtitle="" :is-subtitle-hidden="true">
    ...
    <div v-if="dataDefinitiveVote.length!==0 && props.qType !== 'OpenEnded'">
      <ChartTabs
              :dataDefinitiveVoteChart="props.dataDefinitiveVote"
              :dataTemporaryVoteChart="props.dataTemporaryVote"
