...
const props = defineProps({
  ...
  /**
   * The chart's definitive data of the vote's tab.
   */
  dataDefinitiveVoteChart: {
    type: Array<{ itemIndex: number, value: number, isCorrect: boolean }>,
    default: () => []
  },
  /**
   * The chart's temporary data of the vote's tab.
   */
  dataTemporaryVoteChart: {
    type: Array<{ itemIndex: number, value: number, isCorrect: boolean }>,
    default: () => []
  },
  /**
    ...
    <v-tabs-window v-model="selectedTab">
      <v-tabs-window-item value="votes">
        <BarChart class="voteChart"
                  :definitive-data="props.dataDefinitiveVoteChart"
                  :temporary-data="props.dataTemporaryVoteChart"
                  title=""
                  :x-label="t('choice')"
