...
internal class RecommendationResolverTest {
    ...
    private val mockMessageBuilder = mock<MessageBuilder> {
        ...
        on { message("player.sequence.recommendation.p1VeryHigh.message") }.doReturn("More than 80% of the answers are correct. Learners have enough knowledge to answer correctly alone.")
        on { message("player.sequence.recommendation.p1TooLow.message") }.doReturn("Less than 20% of the answers are correct. Learners don't have enough knowledge about the topic.")
        ...
        on { message("player.sequence.recommendation.p1VeryHigh_skip.message") }.doReturn("More than 80% of the answers are correct. A brief discussion is enough.")
        on { message("player.sequence.recommendation.p1TooLow_skip.message") }.doReturn("Less than 20% of the answers are correct. A detailed discussion is required.")
