...
/**
 * Contain the data about the progression and the status of a sequence.
 * It's used for learners as they only need this information.
 *
...
/**
 * Contain the data about the progression, the status, the stats of a sequence and the command to manage it.
 * It's used for teachers as they need, in addition to see the progression, to manage the sequence.
 *
 * @param stepsModel The model containing the progression of the sequence.
