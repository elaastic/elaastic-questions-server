...
/**
 * EvaluationSpecification is a class that represents the specification of an evaluation interaction. It contains the
 * number of responses that the user has to evaluate.
 *
