...
internal class RecommendationResolverTest {
    ...
    fun `Test recommendation when there are less than 10 answers`() {
        ...
        val actual =
            RecommendationResolver.resolve(mockResponseSet, emptyList(), mockSequenceStateEndPhase1, mockMessageBuilder)
        MatcherAssert.assertThat(actual, CoreMatchers.`is`(Matchers.nullValue()))
    }
    ...
    fun `Test recommendation when phase 2 skipped and no explanations for correct answers`() {
        ...
        val actual =
            RecommendationResolver.resolve(mockResponseSet, emptyList(), mockSequenceStateEndPhase2, mockMessageBuilder)
        val expected = RecommendationModel(
            noCorrectExplanation = true,
